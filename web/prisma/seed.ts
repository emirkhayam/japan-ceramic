...
async function main() {
  ...
  const products = [
    ...
    { name: "Alchemy Sand", slug: "alchemy-sand", categoryId: stone.id, collection: "Alchemy", color: "Песочный", dimensions: "600×600×10mm", surface: "Структурная", price: 3800, image: "https://images.unsplash.com/photo-1615874959474-d609969a20ed?q=80&w=1200&auto=format&fit=crop" },
    ...
    { name: "Kumo Cloud", slug: "kumo-cloud", categoryId: concrete.id, collection: "Kumo", color: "Облачный", dimensions: "600×600×10mm", surface: "Матовая", price: 3400, image: "https://images.unsplash.com/photo-1604014237800-1c9102c219da?q=80&w=1200&auto=format&fit=crop" },
